...
- Match the whole category meaning, not a shared word. "Financial & Legal Services" is only for financial or legal services, not other professional or software services. If the list has no genuinely fitting software, professional-networking, or dating category, use its most generic catch-all leaf with confidence "low"; do not substitute an unrelated category or invent a label.
