...
export default function SpendingError({ retry }: { retry: () => void }) {
  return (
    <>
      ...
      >
        <h2 className="text-lg font-medium tracking-tight">Spending could not load</h2>
        <p className="mt-2 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
          Your financial data was not changed. Try loading the totals again.
        </p>
        <button
          type="button"
          onClick={retry}
