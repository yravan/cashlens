...
export default function UpcomingError({ retry }: { retry: () => void }) {
  return (
    <>
      ...
      >
        <h2 className="text-lg font-medium tracking-tight">Upcoming charges could not load</h2>
        <p className="mt-2 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
          Your financial data was not changed. Try the projection again.
        </p>
        <button
          type="button"
          onClick={retry}
