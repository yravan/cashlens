...
GRANT UPDATE (
  "state", "applied_category_id", "applied_category_source",
  "applied_category_confidence", "applied_category_reason", "applied_category_run_id",
  "applied_category_revision", "applied_updated_at", "applied_at", "skipped_at",
...
ALTER TABLE "classification_proposals" ALTER CONSTRAINT "classification_proposals_applied_category_owner_fk" DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
...
ALTER TABLE "classification_proposals" ALTER CONSTRAINT "classification_proposals_applied_run_owner_fk" DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
